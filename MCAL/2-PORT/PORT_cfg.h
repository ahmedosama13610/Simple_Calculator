...
/*Configure Pin Direction :1_input
                           2_output
*/					
...
/*Configuration pin initial value :options: (A):in case pin is input:1-FLOATING
                                                                     2-PULLED_UP
											(B):in case pin is input:1-HIGH
* 											                         2-LOW						                                                                      
*																	  
*/
...
#define PORTB_PIN4_INITVAL	  PULLED_UP
#define PORTB_PIN5_INITVAL	  PULLED_UP
#define PORTB_PIN6_INITVAL	  PULLED_UP
#define PORTB_PIN7_INITVAL	  PULLED_UP
